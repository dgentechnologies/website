        ...
        <div className="grid grid-cols-1 gap-8 py-14 md:grid-cols-3">
          ...
          <div className="grid grid-cols-2 gap-8 md:col-span-2 md:grid-cols-3">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2 text-sm">
                <li><a href="https://www.linkedin.com/company/dgentechnology/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-foreground/60 hover:text-foreground"><Linkedin size={16}/> LinkedIn</a></li>
