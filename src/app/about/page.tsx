...
export const teamMembers = [
  ...
  { 
    ...
    twitter: 'https://x.com/_SOMONNOY_?s=20',
  },
  { 
    name: 'Sagnik Mandal', 
    role: 'CMO', 
...
function ValueCard({ value, index }: { value: typeof values[0]; index: number }) {
  ...
  return (
    <div 
      ref={ref}
      className={`flex flex-col items-start text-left p-4 rounded-lg transition-all duration-700 transform hover:-translate-y-2 hover:bg-background/50 hover:shadow-primary/10 hover:shadow-lg ${
        isVisible
    ...
    >
      <CheckCircle className="h-8 w-8 text-primary mb-4" aria-hidden="true" />
    ...
    <div className="flex flex-col overflow-hidden">
      ...
      <section className="relative w-full py-20 md:py-32 bg-card overflow-hidden">
        ...
        <div className="container max-w-screen-xl px-4 md:px-6 relative z-10">
          <div 
            ref={heroRef}
            className={`flex flex-col items-center space-y-4 text-center transition-all duration-700 ${
              heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
          >
            <Badge variant="outline" className="py-1 px-3 border-primary/50 text-primary animate-slide-down">Our Story</Badge>
            <h1 className="text-4xl font-headline font-bold tracking-tighter sm:text-5xl md:text-6xl text-gradient animate-slide-up" style={{ animationDelay: '0.2s' }}>
              Powering India&apos;s Future with Smart Technology
            </h1>
            <p className="mx-auto max-w-[700px] text-foreground/80 md:text-xl animate-slide-up" style={{ animationDelay: '0.4s' }}>
      ...
      <section className="w-full py-16 md:py-24 overflow-hidden">
        <div className="container max-w-screen-xl px-4 md:px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl font-headline font-bold tracking-tighter">Our Journey in Smart City Innovation</h2>
      ...
      <section className="w-full py-16 md:py-24 bg-card overflow-hidden">
        <div className="container max-w-screen-xl px-4 md:px-6">
          ...
          >
            <h2 className="text-3xl font-headline font-bold tracking-tighter">Our Core Values</h2>
      ...
      <section className="w-full py-16 md:py-24 overflow-hidden">
        <div className="container max-w-screen-lg px-4 md:px-6">
          ...
          >
            <h2 className="text-3xl font-headline font-bold tracking-tighter">Meet the Leadership Team</h2>
            <p className="mt-4 text-foreground/70 max-w-2xl mx-auto">
