...
export const metadata: Metadata = {
  ...
  keywords: ['smart city', 'IoT', 'Auralis Ecosystem', 'hardware solutions', 'software solutions', 'smart street light', 'India', 'Kolkata', 'ESP-MESH', 'Hybrid Wireless Mesh Network', 'Made in India', 'Smart Cities Mission', 'affordable smart lighting', 'predictive maintenance', 'technology for society', 'ADAM AI', 'AI companion', 'desktop AI', 'AI hardware'],
