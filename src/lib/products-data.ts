...
export const products: Product[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { url: '/images/solar-product-shot2.png', alt: 'High-efficiency monocrystalline solar panel on Dgen Technologies solar street light', hint: 'solar panel' },
      { url: '/images/solar-product-shot3.png', alt: 'Solar street light illuminating community park at night - Made in India sustainable lighting', hint: 'community park' },
    ],
