export const teamMembers = [
  { 
    ...
    role: 'CEO & CTO', 
    image: '/images/tirthankar-dasgupta-ceo-dgen-technologies.jpg',
    alt: 'Portrait of Tirthankar Dasgupta, CEO and CTO of DGEN Technologies',
    ...
    twitter: 'https://x.com/TirthankarDgen',
  },
  { 
    name: 'Sukomal Debnath', 
    role: 'CFO', 
    image: '/images/sukomal-debnath.jpg',
    alt: 'Portrait of Sukomal Debnath, CFO of DGEN Technologies',
    ...
    twitter: 'https://x.com/_SOMONNOY_',
  },
  { 
    name: 'Sagnik Mandal', 
    role: 'CMO', 
    image: '/images/sagnik-mandal.png',
    alt: 'Portrait of Sagnik Mandal, CMO of DGEN Technologies',
    slug: 'sagnik-mandal',
  ...
  { 
    ...
    alt: 'Portrait of Arpan Bairagi, COO of DGEN Technologies',
    slug: 'arpan-bairagi',
