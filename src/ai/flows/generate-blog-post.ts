...
*   **Tirthankar Dasgupta (CEO & CTO):**
    *   **Voice:** Visionary, technical, and forward-looking.
...
4.  **Output Format:** Provide the output in the specified JSON format, including a title, SEO-friendly description, a URL-friendly slug, tags, and the full HTML content. The date should be today's date.
`;
