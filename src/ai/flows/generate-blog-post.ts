...
4.  **Output Format:** Provide the output in a structured JSON format. Do not add any markdown formatting (e.g. \`\`\`json\`) to the output. The date should be today's date.
`;
