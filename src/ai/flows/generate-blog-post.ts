...
4.  **Output Format:** Provide the output in the specified JSON format, including a title, SEO-friendly description, a URL-friendly slug, tags, the full HTML content, and a hero image. The date should be today's date.
`;
